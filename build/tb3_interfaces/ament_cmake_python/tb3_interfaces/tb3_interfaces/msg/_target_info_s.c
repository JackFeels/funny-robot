...
bool tb3_interfaces__msg__target_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tb3_interfaces.msg._target_info.TargetInfo", full_classname_dest, 42) == 0);
  }
  tb3_interfaces__msg__TargetInfo * ros_message = _ros_message;
  {  // locked
...
PyObject * tb3_interfaces__msg__target_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tb3_interfaces.msg._target_info");
