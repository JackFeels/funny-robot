...
bool tb3_interfaces__msg__tracked_person__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tb3_interfaces.msg._tracked_person.TrackedPerson", full_classname_dest, 48) == 0);
  }
  tb3_interfaces__msg__TrackedPerson * ros_message = _ros_message;
  {  // id
...
PyObject * tb3_interfaces__msg__tracked_person__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tb3_interfaces.msg._tracked_person");
