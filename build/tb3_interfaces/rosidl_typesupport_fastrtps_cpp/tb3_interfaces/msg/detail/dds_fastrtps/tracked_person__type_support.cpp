...
#include "tb3_interfaces/msg/detail/tracked_person__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tb3_interfaces::msg::TrackedPerson & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tb3_interfaces::msg::TrackedPerson & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tb3_interfaces::msg::TrackedPerson;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tb3_interfaces::msg::TrackedPerson *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tb3_interfaces::msg::TrackedPerson *>(
    untyped_ros_message);
...
get_message_type_support_handle<tb3_interfaces::msg::TrackedPerson>()
{
  return &tb3_interfaces::msg::typesupport_fastrtps_cpp::_TrackedPerson__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tb3_interfaces, msg, TrackedPerson)() {
  return &tb3_interfaces::msg::typesupport_fastrtps_cpp::_TrackedPerson__handle;
}
