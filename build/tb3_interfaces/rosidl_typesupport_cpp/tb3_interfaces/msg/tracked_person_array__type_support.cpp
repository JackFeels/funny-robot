...
static const _TrackedPersonArray_type_support_symbol_names_t _TrackedPersonArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tb3_interfaces, msg, TrackedPersonArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tb3_interfaces, msg, TrackedPersonArray)),
  }
};
...
{
  return &::tb3_interfaces::msg::rosidl_typesupport_cpp::TrackedPersonArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tb3_interfaces, msg, TrackedPersonArray)() {
  return get_message_type_support_handle<tb3_interfaces::msg::TrackedPersonArray>();
}
